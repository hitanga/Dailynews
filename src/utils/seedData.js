...
export const DEFAULT_POSTS = [
  {
    ...
    category: "News",
    tags: ["Urban Life", "City Stories", "Architecture", "Morning Edition"],
    slug: "at-daybreak-of-the-fifteenth-day-of-my-search",
    seoTitle: "At Daybreak of the Fifteenth Day – Urban Architecture Story",
    metaDescription: "An evocative morning exploration across the bustling avenues and skyscrapers of the city waking up.",
  ...
  },
  {
    ...
    category: "News",
    tags: ["Photography", "Twilight", "Evening Dispatch", "Travel"],
    slug: "the-sunset-faded-to-twilight",
    seoTitle: "Sunset Faded to Twilight: Evening Reflections in the Creative Quarter",
    metaDescription: "Exploring the nuances of twilight photography and urban stillness in the creative district.",
  ...
  },
  {
    ...
    category: "Fun Facts",
    tags: ["Coffee Facts", "Food Trivia", "Amazing Facts", "History"],
    slug: "coffee-beans-are-fruit-seeds-trivia",
    seoTitle: "Did You Know Coffee Beans Are Actually Fruit Seeds? Surprising Facts",
    metaDescription: "Discover how ancient Ethiopian nomads first ate coffee cherries and why coffee beans are actually fruit seeds.",
  ...
  },
  {
    ...
    category: "News",
    tags: ["Solo Travel", "Motorcycles", "Highway Chronicles"],
    slug: "two-long-weeks-i-wandered-along-the-highway",
    seoTitle: "Two Long Weeks on the Highway: Solo Motorcycling Journey",
    metaDescription: "A compelling dispatch on road trips, freedom on two wheels, and open highways.",
    dateString: "April 8, 2019",
    commentsCount: 1,
  },
  {
    ...
    category: "Fun Facts",
    tags: ["Amazing Facts", "Hindi Facts", "Science Facts", "Honey Facts", "रोचक तथ्य", "विज्ञान के तथ्य", "शहद"],
    slug: "shahad-kharab-kyun-nahi-hota-amazing-fact",
    seoTitle: "क्या शहद कभी खराब नहीं होता? जानिए इसका Amazing Science Fact",
    metaDescription: "क्या आप जानते हैं कि सही परिस्थितियों में शहद असाधारण रूप से लंबे समय तक सुरक्षित रह सकता है? जानिए इसके पीछे छिपा fascinating science.",
  ...
  },
  {
    ...
    category: "News",
    tags: ["Markets", "Finance", "Economy", "Banking"],
    slug: "global-financial-markets-shift-central-banks",
    seoTitle: "Global Financial Markets Shift as Central Banks Signal Rate Pauses",
    metaDescription: "Analyzing international equity markets, monetary policy moves, and macroeconomic trends.",
    dateString: "February 1, 2019",
    commentsCount: 4,
  },
  {
    ...
    category: "Fun Facts",
    tags: ["Science Facts", "Animal Kingdom", "Amazing Facts", "Nature"],
    slug: "why-flamingos-turn-pink-diet-facts",
    seoTitle: "Why Flamingos Are Born Grey and Turn Pink: The Biology Behind the Color",
    metaDescription: "Discover how carotenoids in brine shrimp and algae transform dull grey flamingo chicks into vibrant pink birds.",
  ...
  },
  {
    ...
    category: "Fun Facts",
    tags: ["History Facts", "Engineering", "Architecture", "Amazing Facts"],
    slug: "great-wall-china-sticky-rice-mortar",
    seoTitle: "The Great Wall of China is Held Together by Sticky Rice Mortar",
    metaDescription: "How ancient Ming Dynasty masons used sticky rice broth to create an earthquake-resistant mortar for the Great Wall.",
  ...
  },
  {
    ...
    category: "News",
    tags: ["Clean Energy", "Technology", "Climate", "Infrastructure"],
    slug: "renewable-energy-capacity-surpasses-forecasts",
    seoTitle: "Renewable Energy Capacity Surpasses Forecasts Across Major Metros",
    metaDescription: "Municipal solar and wind grid expansion reports show record adoption rates for clean energy.",
